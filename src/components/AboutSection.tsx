...
// const highlights = [
//   // "Next-generation multi-omics experiments",
...
//                     {service.heading}
//                   </h3>
//                   <span className="text-foreground font-medium">{service.content}</span>
//                 </div>
//               ))}
//             </div>
...
//                 <div
//                   key={service.heading}
//                   className="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-up border-t-4 border-accent"
//                   style={{ animationDelay: `${index * 0.1}s` }}
//                 >
//                   Icon
